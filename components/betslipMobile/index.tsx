...
const BetSlipMobile: React.FC<BetSlipProps> = ({ onMessage }) => {
  ...
  const mainClassName = `${classes.betSlip} ${classes.betSlipMobile}`;
  ...
  const handleToggleBetSlip = () => {
    return dispatch(toggleShowBetSlip(!showBet));
  };
                ...
                <div className={classes["betData-block"]}>
                  {betsData.map((betData) => (
                    <div className={classes.mainContent} key={betData.odd.id}>
                      <div className={classes.boxClose}>
                        <div onClick={() => handleCancelBetSlip(betData.odd)}>
                          <CloseIcon />
                        </div>
                      ...
                      <div className={classes.info}>
                        <div className={classes.matchName}>
                          <p>
                            {
                              leagues.find(
                                (league) => league.id === betData.league.id
                              )?.korean_name
                            }
                          </p>
                        </div>
                        <div className={classes.subMatchName}>
                          {
                            teams.find((team) => team.id === betData.home.id)
                              ?.korea_name
                          }{" "}
                          vs{" "}
                          {
                            teams.find((team) => team.id === betData.away.id)
                              ?.korea_name
                          }
                        </div>
                        <div className={classes.exchangeRate}>
